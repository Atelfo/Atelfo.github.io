...
Overall, the US accounts for 40-50% of total pharmaceutical product revenue (specific estimates vary e.g. 45%[^4], 48%[^5]). However, the split of US vs. rest of world revenues differs significantly by product and indication principally because the US has historically had free pricing rather than health technology assessment driven reimbursement, which tends to affect certain indications more than others, for example:[^5]
- Solid tumour indications, cardiology, vaccines and infectious diseases are among the therapy areas with more even US vs. rest of world revenues
- Revenue from immunology, dermatology and hematologic malignancies tend to be heavily weighted towards the US
...
- Nordics (Norway, Sweden, Denmark, Finland, Iceland):
	- $13 billion (Efpia using IQVIA data, 2016)[^2]
	- $13.1 billion (OECD, 2018)[^6]
- Benelux (Belgium, Netherlands, Luxembourg): 
	- $11.9 billion (Efpia using IQVIA data, 2016 - not including Luxembourg)[^2]
