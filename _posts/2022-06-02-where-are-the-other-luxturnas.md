...
![](/assets/Pasted image 20220418200851.png | width=400)
...
#### Limited AAV packaging capacity
AAV vectors - the currently dominant transgene delivery vehicle for IRD gene therapies - can carry up to 5kb[^30] of DNA. However, many IRDs are caused by mutations in genes that are larger than the carrying capacity of AAVs[^23], a sample of which are shown in the table below.
